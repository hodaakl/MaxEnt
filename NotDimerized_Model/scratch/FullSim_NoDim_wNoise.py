...
# Created 04/02/2021 <br>
# Maximum Entropy inference of cellular parameter distribution using an analytically solvable model by moment closure and adding in noise. 
...
n_list = np.arange(2,101) # I have 19 noise factors 
for n_p in n_list : 
    OF = f'/blue/pdixit/hodaakl/output/Noise_NoDim_0403/Noise_{n_p}/'
...
n_cv = n_p # determining the level of noise 
outputfolder = OF  # determining th outputfolder 


# In[14]:


# determining the level of noise and setting the output folder 
...
# defining functions for the simulation and update of lambda


def segfr_preds(L,  pars_arr,n=n_cv, SF = 0.00122 ):# The SF is to change from a.u. to molecules based on 305 a.u. = 250*10^3 molecules  ):

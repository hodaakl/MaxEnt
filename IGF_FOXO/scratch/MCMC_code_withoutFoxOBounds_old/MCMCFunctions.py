...
## 
def RunMCMC(outpath, Lagrange_multi, norm_lagrange, Cons_Bound_dict, params_upperbound = highbound, params_lowerbound = lowbound,  N_chain= 10, save_step = 2, ignore_steps = 2, iteration = 1 , param_range = 0.1, num_par_change = 5, timethis=False, nBins = 10):

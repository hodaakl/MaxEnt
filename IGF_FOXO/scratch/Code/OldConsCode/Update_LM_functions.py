...
def update_lambda(Error, old_lambda,norm_vector,  alpha_cons = 0.05 ):#, alpha_power = 1): true_constraints , alpha_arr,
    ...
    Lambda = old_lambda + alpha_cons*(Error)/norm_vector[:nCons]
